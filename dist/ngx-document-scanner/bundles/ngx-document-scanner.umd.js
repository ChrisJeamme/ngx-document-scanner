(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-document-scanner'] = {}, global.ng.core, global.rxjs, global.ng.material.bottomSheet, global.ngxOpencv, global.ng.flexLayout, global.angular2Draggable, global.ng.common, global.ng.material.button, global.ng.material.icon, global.ng.material.list));
}(this, (function (exports, i0, rxjs, bottomSheet, ngxOpencv, flexLayout, angular2Draggable, common, button, icon, list) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ LimitsService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function LimitsService_Factory() { return new LimitsService(); }, token: LimitsService, providedIn: "root" });
    ...
    NgxFilterMenuComponent.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: i0.Inject, args: [bottomSheet.MAT_BOTTOM_SHEET_DATA,] }] }
    ]; };
